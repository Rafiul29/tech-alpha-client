      ...
      <div className="texts flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center font-medium text-rose-500">
          ...
          <button
            ...
            className="uppercase bg-violet-500 text-violet-50 font-medium py-3 px-8 rounded-md hover:bg-rose-500 hover:text-rose-50 duration-300 shadow-lg shadow-violet-300 hover:shadow-rose-300"
          >
            Add to cart
          </button>
        </div>
